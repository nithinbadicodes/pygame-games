...
BG_IMAGE = pygame.image.load('Game2/assets/space.png')
BG = pygame.transform.scale(BG_IMAGE,(WIDTH,HEIGHT))

YELLOW_SPACESHIP_IMAGE = pygame.transform.rotate(pygame.image.load('Game2/assets/spaceship_yellow.png'),90)
RED_SPACESHIP_IMAGE = pygame.transform.rotate(pygame.image.load('Game2/assets/spaceship_red.png'),-90)
